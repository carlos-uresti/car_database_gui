...
def input_query():
  ...
  reserve_qry_btn.grid(row = 11, column =1, columnspan = 1, pady = 10, padx = 5, ipadx = 100)
...
#vehicle category dropdown menu
vehicleRentalType = ["1", "7"]
category4 = StringVar()
category4.set("Rental Type")
drop2 = OptionMenu(tab5, category4, *vehicleRentalType)
